...
@section('content')
  <pagina tamanho="18">
    ...
    <painel titulo="Listar Tarefas">
      ...
      <tabela-lista
      v-bind:titulos="['Código','Título','Categoria','Autor','data de Criação']"
  ...
  <modal nome="editar" titulo="Editar">
    <formulario id="formEditar" v-bind:action="'/admin/artigos/' + $store.state.item.id" method="put" enctype="" token="{{ csrf_token() }}">
      ...
      <div class="form-group">
        <label for="descricao">Categoria</label>
        <input type="text" class="form-control" id="Categoria" name="Categoria" v-model="$store.state.item.descricao" placeholder="Categoria">
      </div>
      <div class="form-group">
